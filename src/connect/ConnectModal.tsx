            ...
            <div className={tw`flex-1 flex flex-col min-h-[350px] space-y-2`}>
              ...
              <div className={tw`flex flex-col px-2`}>
                <div className={tw`w-full flex-grow flex flex-col-reverse`}>
                  ...
                  >
                    <div
                      className={tw`block flex-grow border-solid border border-t border-b-0 border-x-0 h-px mr-6`}
                    ></div>
                    <div className={tw`block`}>or</div>
                    <div
                      className={tw`block flex-grow border-solid border border-t border-b-0 border-x-0 h-px ml-6`}
                    ></div>
                  </div>
                </div>
                <NewWalletButton
